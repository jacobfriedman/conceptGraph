...
export class HTMLFragment extends DocumentPersistentFragment {
    ...
    constructor(identifier, thisFragmentOriginalType = 'thing', node) {
...
let HTMLFragmentSeeder = function(identifier, parentIdentifier, type, node) {
    ...
    if(parentIdentifier === undefined) {
        ...
        let thisDocument = document.implementation.createHTMLDocument().documentElement;
            thisDocument.getElementsByTagName('body')[0].setAttribute('identifier',identifier)

          HTMLFragmentStore[identifier] = '<!DOCTYPE html>'+thisDocument.innerHTML;


       /*   document.open("text/html", "replace");
          document.write(HTMLFragmentStore[identifier]);
          document.close();
    ...
    if(parentIdentifier !== undefined) {
        ...
        let parents = document.documentElement.querySelectorAll(`[identifier=${parentIdentifier}]`);
